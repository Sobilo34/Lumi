    ...
    def __init__(self) -> None:
        self._definitions: list[ScreenDefinition] = [
            ...
            ScreenDefinition(
                ...
                (
                    HitboxDefinition("Home", 0.01, 0.02, 0.06, 0.1, target="world_map"),
                    HitboxDefinition("Card cat", 0.24, 0.39, 0.14, 0.27, action="select_word_cat"),
                    HitboxDefinition("Card dog", 0.4, 0.39, 0.14, 0.27, action="select_word_dog"),
                    HitboxDefinition("Card sun", 0.56, 0.39, 0.14, 0.27, action="select_word_sun"),
                    HitboxDefinition("Card ball", 0.72, 0.39, 0.14, 0.27, action="select_word_ball"),
                    HitboxDefinition("Repeat", 0.31, 0.77, 0.1, 0.18, action="repeat_prompt"),
                    HitboxDefinition("Hint", 0.45, 0.77, 0.11, 0.18, action="show_hint"),
