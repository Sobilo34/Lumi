        ...
        self._definitions: list[ScreenDefinition] = [
            ...
            ScreenDefinition(
                ...
                (
                    ...
                    HitboxDefinition("Card B", 0.29, 0.41, 0.13, 0.25, target="letter_correct_feedback"),
                    HitboxDefinition("Card D", 0.43, 0.41, 0.13, 0.25, target="letter_mistake_hint"),
                    HitboxDefinition("Card P", 0.57, 0.41, 0.13, 0.25, target="letter_mistake_hint"),
                    HitboxDefinition("Card A", 0.71, 0.41, 0.13, 0.25, target="letter_mistake_hint"),
                    HitboxDefinition("Repeat", 0.31, 0.77, 0.1, 0.18, action="repeat_prompt"),
                    HitboxDefinition("Hint", 0.45, 0.77, 0.11, 0.18, target="letter_mistake_hint"),
                    HitboxDefinition("Speak", 0.6, 0.77, 0.1, 0.18, target="voice_challenge"),
                ),
            ),
